    ...
    <body>
        ...
        <div class="py-3 container heading-block">
          ...
          <div class="heading-row">
            ...
            <a href=""><h4>Xem sản phẩm <i class="fas fa-chevron-circle-right more-infor__icon " ></i></h4></a>  
          ...
          <div class="product-lists">
            <div class="col-md-5 col-xs-5 product-item">
              <a href="" class="select-item">
                <img
                  src="https://www.mbageas.life/uploads/LVaKpT5PP-FvALtolvFcc/1615516000631_original.jpg"
                  alt=""
                  class="product-img"
                />
              </a>
              ...
              <div class="product-item-hover">
                ...
                <p class="content-product">
                  ...
                  impedit officiis asperiores velit! Soluta explicabo repellat,
                  nobis minus quis hic natus! Dolor modi laudantium ipsa, quisquam
                  veniam provident voluptas expedita!
                </p>
              </div>
            </div>
    
            <div class="col-md-5 col-xs-5 product-item"></div>
            <div class="col-md-5 col-xs-5 product-item"></div>
            <div class="col-md-5 col-xs-5 product-item"></div>
          </div>
        </div>
